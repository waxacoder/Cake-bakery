  ...
  return (
    <div className="bg-white2  w-[70%]">
      ...
      <div className="mt-6 flex flex-wrap gap-5 pl-[40px]  h-full max-h-[calc(100vh-150px)] overflow-auto pb-5">
        <Cart img1={img1} like={like} box={box} star={star} star2={star2} />
        <Cart img1={img2} like={like} box={box} star={star} star2={star2} />
        <Cart img1={img3} like={like} box={box} star={star} star2={star2} />
        <Cart img1={img1} like={like} box={box} star={star} star2={star2} />
        <Cart img1={img2} like={like} box={box} star={star} star2={star2} />
        <Cart img1={img3} like={like} box={box} star={star} star2={star2} />
        <Cart img1={img1} like={like} box={box} star={star} star2={star2} />
